...
(function (window) {
  ...
  var booleans = 'checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|' +
  ...
  var rtrim = new RegExp('^' + whitespace + '+|((?:^|[^\\\\])(?:\\\\.)*)' +
		whitespace + '+$', 'g')
 ...
 */
  ...
  function setMatcher (preFilter, selector, matcher, postFilter, postFinder, postSelector) {
    ...
    return markFunction(function (seed, results, context, xml) {
      ...
      var elems = seed || multipleContexts(
        selector || '*',
 ...
 */
  ...
  (function () {
    ...
    var reliableTrDimensionsVal; var reliableMarginLeftVal
